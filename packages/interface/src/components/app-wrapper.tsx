...
export function AppWrapper({ children }: React.PropsWithChildren) {
  ...
  return (
    <div className="relative flex min-h-screen flex-col bg-background">
          ...
          <div className="flex items-center">
            ...
            {/* <nav className="flex items-center">
              <a href={"https://github.com/multichainer-eth-sea"}>
                <div className="inline-flex h-8 w-8 items-center justify-center whitespace-nowrap rounded-md px-0 py-2 text-sm font-medium transition-colors hover:bg-accent hover:text-accent-foreground focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50">
      ...
      <footer className="border py-6 md:px-8 md:py-0">
